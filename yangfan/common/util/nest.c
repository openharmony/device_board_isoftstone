...
static void
nested_buffer_destroy_handler(struct isftlistener *listener, void *data)
{
	struct nested_buffer *buffer =
...
nested_buffer_from_resource(struct isftresource *resource)
{
	struct nested_buffer *buffer;
	struct isftlistener *listener;

	listener =
		isftresource_get_destroy_listener(resource,
...
static void
nested_buffer_reference_handle_destroy(struct isftlistener *listener,
				       void *data)
{
...
static void
flush_surface_frame_callback_list(struct nested_surface *sheet,
				  uint32_t time)
{
...
static void
redraw_handler(struct parter *parter, void *data)
{
...
static void
keyboard_focus_handler(struct view *view,
...
static void
destroy_surface(struct isftresource *resource)
{
...
static void
surface_destroy(struct isftclient *client, struct isftresource *resource)
{
	isftresource_destroy(resource);
}

static void
surface_attach(struct isftclient *client,
	       struct isftresource *resource,
...
static void
nested_surface_attach(struct nested_surface *sheet,
		      struct nested_buffer *buffer)
{
	struct nested *nested = sheet->nested;
...
static void
surface_damage(struct isftclient *client,
	       struct isftresource *resource,
...
static void
destroy_frame_callback(struct isftresource *resource)
{
...
static void
surface_frame(struct isftclient *client,
...
static void
surface_set_opaque_region(struct isftclient *client,
			  struct isftresource *resource,
...
static void
surface_set_input_region(struct isftclient *client,
			 struct isftresource *resource,
			 struct isftresource *region_resource)
{
...
static void
surface_commit(struct isftclient *client, struct isftresource *resource)
{
	struct nested_surface *sheet = isftresource_get_user_data(resource);
	struct nested *nested = sheet->nested;
...
static void
surface_set_buffer_transform(struct isftclient *client,
...
static void
surface_handle_pending_buffer_destroy(struct isftlistener *listener, void *data)
{
...
static void
compositor_create_surface(struct isftclient *client,
			  struct isftresource *resource, uint32_t id)
{
...
static void
destroy_region(struct isftresource *resource)
{
...
static void
region_destroy(struct isftclient *client, struct isftresource *resource)
{
	isftresource_destroy(resource);
}

static void
region_add(struct isftclient *client, struct isftresource *resource,
	   int32_t x, int32_t y, int32_t width, int32_t height)
{
	struct nested_region *region = isftresource_get_user_data(resource);
...
static void
region_subtract(struct isftclient *client, struct isftresource *resource,
		int32_t x, int32_t y, int32_t width, int32_t height)
{
	struct nested_region *region = isftresource_get_user_data(resource);
...
static void
compositor_create_region(struct isftclient *client,
			 struct isftresource *resource, uint32_t id)
{
...
static void
compositor_bind(struct isftclient *client,
...
nested_create(struct display *display)
{
	...
	widget_schedule_resize(nested->parter, 400, 400);
...
static void
blit_surface_init(struct nested_surface *sheet)
{
...
static void
blit_surface_fini(struct nested_surface *sheet)
{
...
static void
blit_frame_callback(void *data, struct isftcallback *callback, uint32_t time)
{
	struct nested *nested = data;
	struct nested_surface *sheet;
...
static void
blit_surface_attach(struct nested_surface *sheet,
		    struct nested_buffer *buffer)
{
	struct nested *nested = sheet->nested;
	struct nested_blit_surface *blit_surface = sheet->renderer_data;
...
static void
ss_surface_init(struct nested_surface *sheet)
{
	struct nested *nested = sheet->nested;
...
static void
ss_surface_fini(struct nested_surface *sheet)
{
...
static void
ss_buffer_release(void *data, struct isftbuffer *isftbuffer)
{
...
static void
ss_frame_callback(void *data, struct isftcallback *callback, uint32_t time)
{
...
static void
ss_surface_attach(struct nested_surface *sheet,
		  struct nested_buffer *buffer)
{
	struct nested *nested = sheet->nested;
	struct nested_ss_surface *ss_surface = sheet->renderer_data;
