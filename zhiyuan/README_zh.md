...
“致远”搭载全志T507芯片，基于ARM架构，四核64位处理器，支持WIFI、音频、视频和摄像头等功能。拥有丰富的扩展接口，以及多种视频输入输出接口；
...
本文档用来指导开发者在致远开发上进行OpenHarmony系统的移植开发。

## 开发板规格

全志T507采用四核64位Cortex-A53处理器，主频高达1.5GHz，集成Mali-400 G31 GPU，具有低功耗高性能的特点，可广泛应用于工业控制、智能驾舱、智慧家居、智慧电力、在线教育等诸多行业需求。
...
开发板无镜像上电或者切换至usb升级模式时，如果PC端没有安装驱动，在设备管理器中将会被识别成未知设备，按以下步骤安装usb驱动即可：驱动在解压出来的目录下：UsbDriver

开发板上电开机，用MicroUSB线连接到电脑，查看是否检测到设备(首次需要安装驱动)
...
​		按住开发板上的**OTA按键**，然后按**RST按键**，如弹出如下弹窗说明开发板进入升级模式。
