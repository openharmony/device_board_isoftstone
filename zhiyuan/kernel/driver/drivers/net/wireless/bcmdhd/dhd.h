...
#else
#define DHD_SSSR_MEMPOOL_INIT(dhdp)    do { } while (0)
#define DHD_SSSR_MEMPOOL_DEINIT(dhdp)  do { } while (0)
#define DHD_SSSR_DUMP_INIT(dhdp)       do { } while (0)
#define DHD_SSSR_DUMP_DEINIT(dhdp)     do { } while (0)
#endif /* DHD_SSSR_DUMP */
