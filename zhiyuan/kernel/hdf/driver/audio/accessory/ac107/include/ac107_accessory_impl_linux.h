...
int32_t Ac107DeviceInit(struct AudioCard *audioCard);
int32_t Ac107DeviceReadReg(uint32_t reg, uint32_t *value);
int32_t Ac107DeviceWriteReg(uint32_t reg, uint32_t value);
